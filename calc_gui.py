...
class Calc(tk.Tk):
    ...
    def create_number_frame(self,frame):
        self.but0 = tk.Button(frame,text='0', command=lambda: self.logic.update('0'))
        self.but0.grid(column=1,row=3,sticky='NSEW')
        self.but1 = tk.Button(frame,text='1', command=lambda: self.logic.update('1'))
        self.but1.grid(column=0,row=2,sticky='NSEW')
        self.but2 = tk.Button(frame,text='2', command=lambda: self.logic.update('2'))
        self.but2.grid(column=1,row=2,sticky='NSEW')
        self.but3 = tk.Button(frame,text='3', command=lambda: self.logic.update('3'))
        self.but3.grid(column=2,row=2,sticky='NSEW')
        self.but4 = tk.Button(frame,text='4', command=lambda: self.logic.update('4'))
        self.but4.grid(column=0,row=1,sticky='NSEW')
        self.but5 = tk.Button(frame,text='5', command=lambda: self.logic.update('5'))
        self.but5.grid(column=1,row=1,sticky='NSEW')
        self.but6 = tk.Button(frame,text='6', command=lambda: self.logic.update('6'))
        self.but6.grid(column=2,row=1,sticky='NSEW')
        self.but7 = tk.Button(frame,text='7', command=lambda: self.logic.update('7'))
        self.but7.grid(column=0,row=0,sticky='NSEW')
        self.but8 = tk.Button(frame,text='8', command=lambda: self.logic.update('8'))
        self.but8.grid(column=1,row=0,sticky='NSEW')
        self.but9 = tk.Button(frame,text='9', command=lambda: self.logic.update('9'))
        ...
        self.but_point = tk.Button(frame,text='.', command=lambda: self.logic.update('.'))
        self.but_point.grid(column=0,row=3,sticky='NSEW')
        self.but_add = tk.Button(frame,text='+', command=lambda: self.logic.update('+'))
        self.but_add.grid(row=0,column=3,sticky='NSEW')
        self.but_diff = tk.Button(frame,text='-', command=lambda: self.logic.update('-'))
        self.but_diff.grid(row=1,column=3,sticky='NSEW')
        self.but_molt = tk.Button(frame, text='\u00d7', command=lambda: self.logic.update('\u00d7'))
        self.but_molt.grid(row=2,column=3,sticky='NSEW')
        self.but_div = tk.Button(frame, text='/', command=lambda: self.logic.update('/'))
        self.but_div.grid(row=3,column=3,sticky='NSEW')
        self.but_ans = tk.Button(frame,text='Ans', command=lambda: self.logic.callback('Ans'))
        self.but_ans.grid(row=0,column=4)
